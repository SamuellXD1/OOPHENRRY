...
public class Calculadora extends javax.swing.JFrame {
    ...
    this.N1 = Float.parseFloat(this.vista.getText());
    this.operador = "+";
    this.vista.setText("");
    }//GEN-LAST:event_jButton15ActionPerformed

    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        this.N2 = Float.parseFloat(this.vista.getText());

        switch (this.operador) {
            case "+":
                this.vista.setText(Float.toString(this.N1 + this.N2));
                break;
            case "-":
                this.vista.setText(Float.toString(this.N1 - this.N2));
                break;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
         String texto = this.vista.getText();
    if (texto.isEmpty()) {
        this.vista.setText("-");
    } else if (texto.equals("-")) {
        return;
    } else {
        this.N1 = Float.parseFloat(texto);
        this.operador = "-";
        this.vista.setText("");
    }
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
       if (!(this.vista.getText().contains(".")))   
        {
